...
const planesController = {
  ...
  imprimirPlan(idPlan) {
    const plan = (this._planesData || []).find(
      (p) => p.id_plan_tratamiento == idPlan,
    );
    if (!plan) return;
    ...
    ventana.document.write(
      '<!DOCTYPE html><html lang="es"><head><meta charset="UTF-8">' +
        ...
        '<div class="titulo">Plan de Tratamiento #' +
        plan.numero_plan +
        "</div>" +
        '<div class="info-grid">' +
        '<div class="info-item"><span class="info-label">Paciente</span><span class="info-value">' +
        escHtml(nombre || "No especificado") +
        "</span></div>" +
        '<div class="info-item"><span class="info-label">Especialista</span><span class="info-value">' +
        escHtml(plan.especialista) +
        "</span></div>" +
        '<div class="info-item"><span class="info-label">Fecha de creaci&oacute;n</span><span class="info-value">' +
        formatFecha(plan.fecha_creacion) +
        "</span></div>" +
        '<div class="info-item"><span class="info-label">Estatus</span><span class="info-value">' +
        plan.estatus_tratamiento +
        "</span></div>" +
        '<div class="info-item"><span class="info-label">Total del plan</span><span class="info-value">' +
        fmt(plan.costo_total) +
        "</span></div>" +
        "</div>" +
        notasHtml +
        "<table><thead><tr>" +
        ...
        filasDetalle +
        "</tbody></table>" +
        '<div class="total-bar"><span>TOTAL DEL PLAN</span><span>' +
        fmt(plan.costo_total) +
        "</span></div>" +
        '<div class="footer">' +
