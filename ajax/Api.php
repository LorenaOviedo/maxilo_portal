...
$modulos = [
    ...
    'motivos_consulta' => [
        ...
        'archivo' => __DIR__ . '/../models/MotivoConsulta.php',
        'campo_id' => 'id_motivo_consulta',
    ],

    'antecedentes_medicos' => [
        'modelo' => 'AntecedenteMedico',
        'archivo' => __DIR__ . '/../models/AntecedenteMedico.php',
        'campo_id' => 'id_antecedente',
    ],
