    ...
    <div class="modal-body">
        <form class="modal-form" id="formPago" autocomplete="off">
                    ...
                    <div style="display:flex; justify-content:space-between;
                        ...
                        <div>
                            <div style="font-weight:700; font-size:14px;"
                                id="pagoCitaPaciente">—</div>
                            <div style="font-size:12px; color:#6c757d; margin-top:3px;"
                                id="pagoCitaEspecialista">—</div>
                            <div style="font-size:12px; color:#6c757d; margin-top:2px;"
                                id="pagoCitaMotivo">—</div>
                        </div>
                        <div style="text-align:right;">
                            <div style="font-size:11px; color:#6c757d;">Costo de cita</div>
                            <div style="font-size:20px; font-weight:700; color:#20a89e;"
                                id="pagoCitaCosto">—</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-row cols-1" id="pagoGrupoRef" style="display:none;">
                <div class="form-group">
                    <label class="form-label">
                        Referencia / Número de autorización <span class="required">*</span>
                    </label>
                    <input type="text" id="pagoReferencia" name="referencia_pago"
            ...
            <div class="form-row cols-2">
                <div class="form-group">
                    ...
                    <input type="number" id="pagoMontoTotal" name="monto_total"
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="pagoMontoNeto" name="monto_neto"
                        class="form-input" min="0.01" step="0.01"
                        placeholder="0.00" autocomplete="off">
            ...
            <div class="form-row cols-1">
                <div class="form-group">
                    ...
                    <textarea id="pagoObservaciones" name="observaciones"
