...
<main class="main-content">
    ...
    <div class="search-actions-bar">
        <div class="search-box">
            <input type="text" class="search-input" placeholder="Buscar por procedimiento, tipo, especialidad..."
                id="searchInput">
        </div>
                        ...
                        <tr>
                            ...
                            <td class="col-actions" data-label="Acciones">
                                <div class="action-buttons">
                                    <!-- Ver (modo lectura) -->
                                    <button type="button" class="btn-action btn-view" title="Ver procedimiento"
                                        onclick="abrirModalVer(<?php echo $p['id_procedimiento']; ?>)">
                                        <i class="ri-eye-line"></i>
                                    </button>
                                    <!-- Editar -->
                                    <button type="button" class="btn-action btn-edit" title="Editar procedimiento"
                                    ...
                                    <button type="button"
                                        ...
                                        title="<?php echo $activo ? 'Desactivar' : 'Activar'; ?>" onclick="cambiarEstatusConfirmar(
                                                <?php echo $p['id_procedimiento']; ?>,
                                                <?php echo $activo ? 2 : 1; ?>,
                                                '<?php echo htmlspecialchars($p['nombre_procedimiento']); ?>'
                                            )">
