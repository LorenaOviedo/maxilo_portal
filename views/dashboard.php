...
<main class="main-content">
    ...
    <div class="dashboard-grid">
        ...
        <div class="calendar-card">
            ...
            <div class="calendar">
                ...
                <div class="calendar-body">
                    ...
                    <?php
                    $dias_mes_anterior = [23, 24, 25, 26, 27, 28];
                    foreach ($dias_mes_anterior as $dia) {
                        echo '<div class="calendar-day prev-month">' . $dia . '</div>';
                    }

                    for ($dia = 1; $dia <= 31; $dia++) {
                        $clase = ($dia == 24) ? 'calendar-day current-day' : 'calendar-day';
                        echo '<div class="' . $clase . '">' . $dia . '</div>';
                    }

                    $restantes = (7 - ((count($dias_mes_anterior) + 31) % 7)) % 7;
        ...
        <div class="stats-card">
            ...
            <div class="card-number" style="font-size: 64px; color: #20a89e; text-align: center; margin: 30px 0;">5
            </div>
        </div>
    </div>
</main>
